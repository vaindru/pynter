...
def setup_mp_database(subparsers):
    ...
    parser_sub.add_argument('-id', '--mp-id', help='Materials project ID', required=True, type=str, metavar='',
                            dest='mp_id')
    parser_sub.add_argument('-s', '--structure', help='print Structure', action='store_true', required=False,
                            default=False, dest='print_structure')
    parser_sub.add_argument('-P', '--poscar', help='create POSCAR', action='store_true', required=False, default=False,
                            dest='write_poscar')
    parser_sub.add_argument('-c', '--conv-cell', help='Get conventional unit cell (default: %(default)s)',
                            action='store_true',
                            required=False, default=False, dest='get_conventional')
    parser_sub.add_argument('-f', '--final-structure', help='Get final structure (default: %(default)s)',
                            action='store_true',
