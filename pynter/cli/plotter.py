...
def setup_plot_bs(parser_sub):
    parser_sub.add_argument('-k', '--kpoints-filename', help='KPOINTS filename', required=False, type=str, default=None,
                            metavar='', dest='kpoints_filename')
    parser_sub.add_argument('-s', '--save', help='Save fig as pdf', required=False, default=False, action='store_true',
                            dest='savefig')
    parser_sub.add_argument('-hy', '--hybrid-mode', help='Force hybrid mode for BS', required=False, default=False,
                            action='store_true', dest='force_hybrid_mode')
    parser_sub.add_argument('-l', '--line-mode', help='Line mode for BS', required=False, default=True,
                            action='store_true', dest='line_mode')
    parser_sub.add_argument('-y', '--ylim', help='Range for y-axis', required=False, default=None, nargs='+',
                            type=float, metavar='', dest='ylim')
    parser_sub.add_argument('-sm', '--smooth', help='Smooth band structure', required=False, default=False,
                            action='store_true', dest='smooth')
    parser_sub.add_argument('-t', '--title', help='Title of the plot', required=False, type=str, default=None,
                            metavar='', dest='title')
...
def setup_plot_dos(parser_sub):
    parser_sub.add_argument('-sg', '--sigma', help='Standard deviation for Gaussian smearing of DOS', required=False,
                            type=float, default=None, metavar='', dest='sigma')
    parser_sub.add_argument('-s', '--save', help='Save fig as pdf', required=False, default=False, action='store_true',
                            dest='savefig')
    parser_sub.add_argument('-st', '--stack', help='Stack DOS', required=False, default=False, action='store_true',
                            dest='stack')
    parser_sub.add_argument('-y', '--ylim', help='Range for y-axis', required=False, default=None, nargs='+',
                            type=float, metavar='', dest='ylim')
    parser_sub.add_argument('-x', '--xlim', help='Range for x-axis', required=False, default=None, nargs='+',
                            type=float, metavar='', dest='xlim')
    parser_sub.add_argument('-p', '--projection', help='Projection of DOS, "elements", "orbitals" or "None"',
                            required=False, type=str, default='elements', metavar='', dest='dos_projection')
    parser_sub.add_argument('-t', '--title', help='Title of the plot', required=False, type=str, default=None,
                            metavar='', dest='title')
...
def setup_plot_dos_bs(parser_sub):
    parser_sub.add_argument('-p', '--path-to-dos',
                            help='Path to Dos object saved as json or path to where vasprun for dos is stored',
                            required=False, type=str, default=None, metavar='', dest='path_to_dos')
    parser_sub.add_argument('-s', '--save', help='Save fig as pdf', required=False, default=False, action='store_true',
                            dest='savefig')
    parser_sub.add_argument('-hy', '--hybrid-mode', help='Force hybrid mode for BS', required=False, default=False,
...
def setup_plot_neb(parser_sub):
    parser_sub.add_argument('-p', '--path', help='Path to NEB calculation', required=False, type=str, default=None,
                            metavar='', dest='path')
    parser_sub.add_argument('-pr', '--print', help='Print energies and forces', required=False, default=False,
                            action='store_true', dest='print_energies')
    parser_sub.add_argument('-s', '--save', help='Save fig as pdf', required=False, default=False, action='store_true',
                            dest='savefig')
    parser_sub.add_argument('-t', '--title', help='Title of the plot', required=False, type=str, default=None,
                            metavar='', dest='title')
