...
class JobSettings(dict, MSONable):
    ...
    def __init__(self, load_slurm_defaults=True, slurm=None, filename=None, array_size=None, modules=None,
        ...
        **kwargs : dict. Additional kwargs which will be automatically assigned to Slurm.
        ...
        settings['add_lines_header'] = add_lines_header if add_lines_header is not None else default_settings[
            'add_lines_header']
        settings['add_lines_body'] = add_lines_body if add_lines_body is not None else default_settings[
            'add_lines_body']
