...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr  4 17:02:23 2023

@author: villa
"""

# Pymatgen version 2022.0.11. The new corrections in the new defects package in pymatgen requires the installation of pydefect.
# This version is an implementation of the pyCDT package but doesn't require any additional installation
...
from pynter.defects.pmg.pmg_defects_core import DefectCorrection
from pynter.defects.pmg.pmg_defects_utils import (
    QModel,
    ang_to_bohr,
    converge,
    eV_to_k,
