...
class TestOxygenPressure(TestChempots):
    ...
    def test_pressure_reservoirs_from_pd(self):
        pres_dict = {
            ...
            3.162e-13: {'Na': -3.07, 'Nb': -13.51, 'O': -7.99},
            1e-05: {'Na': -3.55, 'Nb': -15.94, 'O': -7.02},
            3.162e02: {'Na': -4.03, 'Nb': -18.36, 'O': -6.05},
            1e10: {'Na': -4.51, 'Nb': -20.76, 'O': -5.09}
        }
        ...
        ReservoirsTest().assert_Reservoirs_equal(pres, PressureReservoirs.from_dict(pres.as_dict()),
