...
class TestPDHandler(PynterTest):
    ...
    def test_calculate_single_chempot(self):
        self.assert_all_close(self.pdh.calculate_single_chempot(self.comp, Chempots({'O': -1.92, 'Na': -2.26})), -6.26,
                              atol=1e-02)
    ...
    def test_boundary_chempots(self):
        ...
        ReservoirsTest().assert_Reservoirs_equal(
            Reservoirs(self.pdh.get_all_boundaries_chempots(self.comp)), Reservoirs(boundary_chempots),
